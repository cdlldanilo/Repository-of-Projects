...
Funcionalidade: Realizar Compra no E-commerce
  ...
  Cenario: Realizar Compra
  	Dado que um usuario acessa o site "http://automationpractice.com"
  	E pesquisa pelo produto "Faded Short Sleeve T-shirts"
  	E acessa o produto "Faded Short Sleeve T-shirts"
  	E inclua o produto "Faded Short Sleeve T-shirts" no carrinho
  	E acessa o checkout
  	E realiza o login
