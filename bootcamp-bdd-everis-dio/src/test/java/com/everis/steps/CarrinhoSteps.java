...
public class CarrinhoSteps {
	...
	public void apresentarMensagem(String mensagemExibida) {
		CarrinhoPage carrinhoPage = new CarrinhoPage();
		Assert.assertTrue("Mensagem apresentada: [" + mensagemExibida + "] ",
				carrinhoPage.apresentarMensagem(mensagemExibida));
	}
