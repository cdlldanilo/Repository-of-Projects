...
public class CarrinhoPage extends BasePage {
	...
	public boolean apresentarMensagem(String mensagemExibida) {
		boolean exibiuMensagem = isElementDisplayed(By.xpath("//div[@class='box']"));
		...
		logFail("Não apresentou conforme esperado.");
		return false;
	}
